...
PROTECTED_ATTR = 'sex'
ADMISSIBLE_ATTRS = ['economic_status', 'household_position', 'household_size']
INADMISSIBLE_ATTRS = ['edu_level', 'age', 'marital_status', 'country_birth', 'citizenship', 'prev_residence_place']
OUTCOME = [TARGET_ATTR]
EXTRA_FEATURES = INADMISSIBLE_ATTRS
PROTECTED_ATTRS = [PROTECTED_ATTR]
CONSTRAINT = [PROTECTED_ATTRS, OUTCOME, ADMISSIBLE_ATTRS]
