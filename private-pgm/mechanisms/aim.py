...
def default_params():
    ...
    """
    params = {}
    params["dataset"] = f"../data/Adult_S_Y/cs={i}/train_label.csv"
    params["save"] = f"../data/Adult_S_Y/cs={i}/vanilla_mst/aim.csv"
    params["domain"] = "../data/Adult_S_Y/domain.json"
    params["epsilon"] = 1.0
    params["delta"] = 1e-9
    params["noise"] = "laplace"
    params["max_model_size"] = 1 #80 
...
if __name__ == "__main__":
    ...
    model, synth = mech.run(data, workload, num_synth_rows=10**5)
