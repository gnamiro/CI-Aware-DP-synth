...
def MST(data, outcome, admissible, protected):
    print(outcome, admissible, protected)
    # rho = cdp_rho(epsilon, delta)
    # sigma = np.sqrt(3/(2*rho))
    cliques = [(col,) for col in data.domain]
    log1 = measure(data, cliques)
    data, log1, undo_compress_fn = compress_domain(data, log1)
    cliques = select(data, log1, outcome, admissible,protected)
...
def select(data, measurement_log,outcome,admissible, protected, cliques=[] ):
